function getGraduateCheck(req, res, next) {
	...
	if (req.csca.data.graduate_status != null && req.csca.data.graduate_status.submit_status == '3') req.csca.check_state.reject_reason = req.csca.data.graduate_status.reject_reason;
